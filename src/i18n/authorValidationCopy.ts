...
const baseCopy = {
  en: {
    ...
    archiveTemplates: "Archive-informed templates",
  ...
  it: {
    ...
    archiveTemplates: "Modelli ispirati all'archivio",
  ...
  es: {
    ...
    archiveTemplates: "Plantillas inspiradas en el archivo",
  ...
  de: {
    ...
    archiveTemplates: "Archiv-inspirierte Vorlagen",
