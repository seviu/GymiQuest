...
const parentSummaryCopyBase = {
  de: {
    ...
    learnPurpose: "Eine Lektion mit Erklärung und zwei bis vier adaptiven Aufgaben; die Anzahl steht beim Start fest und Hilfe ist jederzeit erlaubt.",
  ...
  en: {
    ...
    learnPurpose: "One lesson with an explanation and two to four adaptive questions; the question count is fixed when it starts and help may be used at any time.",
...
const parentSummaryCopy = {
  ...
  it: {
    ...
    learnPurpose: "Una lezione con spiegazione e da due a quattro domande adattive; il numero viene fissato all'inizio e l'aiuto si può usare in qualsiasi momento.",
  ...
  es: {
    ...
    learnPurpose: "Una lección con explicación y de dos a cuatro preguntas adaptativas; la cantidad se fija al empezar y se puede usar ayuda en cualquier momento.",
