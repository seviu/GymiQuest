...
const de: GermanSourcePracticeUiCopy = {
  ...
  missingWriting: "Aufsatzthemen und vorhandene Korrekturhinweise importieren",
...
const en: GermanSourcePracticeUiCopy = {
  ...
  missingWriting: "Import essay prompts and any supplied correction guidance",
...
const it: GermanSourcePracticeUiCopy = {
  ...
  missingWriting: "Importa le tracce e le eventuali indicazioni di correzione",
...
const es: GermanSourcePracticeUiCopy = {
  ...
  missingWriting: "Importa los temas y las indicaciones de corrección disponibles",
