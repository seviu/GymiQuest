...
const de: GermanWritingUiCopy = {
  ...
  introBody: "Die Themen sind neu verfasst und an wiederkehrenden Aufgabenformen von 2015 bis 2026 ausgerichtet. Dein Text wird gespeichert, aber nicht automatisch benotet.",
...
const en: GermanWritingUiCopy = {
  ...
  introBody: "The prompts are newly authored and calibrated to recurring task formats from 2015 to 2026. Your text is saved but never automatically graded.",
...
const it: GermanWritingUiCopy = {
  ...
  introBody: "Le tracce sono nuove e calibrate sui formati ricorrenti dal 2015 al 2026. Il testo viene salvato ma non valutato automaticamente.",
...
const es: GermanWritingUiCopy = {
  ...
  introBody: "Los temas son nuevos y están calibrados con formatos recurrentes de 2015 a 2026. El texto se guarda, pero no se califica automáticamente.",
