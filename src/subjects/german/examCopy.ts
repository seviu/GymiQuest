...
const de: GermanExamUiCopy = {
  ...
  cardBody: "15 neue objektive Aufgaben mit durchgehend verfügbarem Textblatt. Punkte und Lernreviews bleiben von Deutsch-XP getrennt.",
  open: "Prüfungsmodus öffnen",
  resume: "Sprachprüfung fortsetzen",
  introTitle: "45 Minuten wie in der Sprachprüfung",
  introBody: "Diese generierte Trainingsprüfung ist keine kopierte offizielle Prüfung. Die Uhr läuft nach dem Start auch weiter, wenn du die App verlässt.",
...
const en: GermanExamUiCopy = {
  ...
  cardBody: "15 fresh objective questions with the text sheet available throughout. Points and learning reviews stay separate from German XP.",
  open: "Open exam mode",
  resume: "Continue language exam",
  introTitle: "45 minutes like the language exam",
  introBody: "This generated training paper is not a copied official exam. Once started, its clock keeps running even if you leave the app.",
...
const it: GermanExamUiCopy = {
  ...
  cardBody: "15 nuove domande oggettive con il foglio di testo sempre disponibile. Punti e ripassi restano separati dagli XP di tedesco.",
  open: "Apri modalità esame",
  resume: "Continua prova di lingua",
  introTitle: "45 minuti come nella prova di lingua",
  introBody: "Questa simulazione generata non copia un esame ufficiale. Dopo l'avvio, il tempo continua anche se lasci l'app.",
...
const es: GermanExamUiCopy = {
  ...
  cardBody: "15 preguntas objetivas nuevas con la hoja de texto siempre disponible. Los puntos y repasos quedan separados de los XP de alemán.",
  open: "Abrir modo examen",
  resume: "Continuar examen de lengua",
  introTitle: "45 minutos como en el examen de lengua",
  introBody: "Esta simulación generada no copia un examen oficial. Tras empezar, el tiempo sigue corriendo aunque salgas de la app.",
