...
**Current child-first completion:** ordinary rounds now finish with the outcome, the actual XP award, one recommended next step, and the return-to-plan action before optional detail. Session evidence, badges, XP rules, mastery evidence, and totals remain under a collapsed native review disclosure; assessment mistake review opens by default so submitted and correct answers are immediately available after final submission. Learner feedback is a separate optional disclosure. No completion evidence, recovery scheduling, mastery update, learner-feedback persistence, or analytics is removed or recalculated by this composition.
